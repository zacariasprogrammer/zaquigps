...
// Trust reverse proxy for Render environment (fixes rate-limiter & IP lookup issues)
...
// Bind to host 0.0.0.0 for Render host routing
app.listen(PORT, '0.0.0.0', () => console.log(`ZaquiGPS Auth Server running on port ${PORT}`));
